...
<header class="site-header">
	<div class="site-wrap site-header__inner">
		<div class="site-branding">
			...
			<?php
			$nimbus_desc = get_bloginfo( 'description', 'display' );
			if ( $nimbus_desc || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo esc_html( $nimbus_desc ); ?></p>
			<?php endif; ?>
		</div>

		<nav class="main-nav" aria-label="<?php esc_attr_e( 'Primary', 'nimbus' ); ?>">
			<?php
			wp_nav_menu( array(
